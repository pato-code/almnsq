        ...
        <div class="card card-container"
            ...
            <div class="card-body">
                <form data-toggle="validator" role="form" id="add_activity" method="POST"
                      action="{{url('/activity/edit/' . $activity->id)}}" aria-label="{{ __('Login') }}"
                            ...
                            <div class="col-md-5">
                                <select id="type_id" class="form-control col-md-12 col-sm-12"
                                    ...
                                    @foreach($types as $type)
                                        <option {{$activity->type_id == $type->id ? 'selected' : ''}} value="{{$type->id}}">{{$type->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-5">
                                <select required="required" id="city_id"
                                    ...
                                    @foreach($cities as $city)
                                        <option {{$activity->city->id == $city->id ? 'selected' : ''}} value="{{$city->id}}">{{$city->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-offset-1 col-md-11  col-sm-12">
                            ...
                            <div class="col-md-5">
                                <select id="neighborhood_id" class="form-control col-md-12 col-sm-12"
                                        ...
                                        style="right: 2%;"
                                        required dir="rtl">
                                    <option selected value="{{$activity->nieghborhood->id}}">{{$activity->nieghborhood->name}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-offset-1 col-md-11 col-sm-12">
                            ...
                            <div class="col-md-5">
                                <select id="mosque_id" class="form-control col-md-12 col-sm-12" name="mosque_id"
                                        ...
                                        required
                                        dir="rtl">
                                    <option selected value="{{$activity->mosque->id}}">{{$activity->mosque->name}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-5 col-sm-12">
                                <select id="period_id" class="wow slideInDown form-control col-md-12 col-sm-12"
                                    ...
                                    @foreach($periods as $period)
                                        <option {{$activity->period_id == $period->id ? 'selected' : ''}} value="{{$period->id}}">{{$period->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
